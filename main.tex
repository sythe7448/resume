...
% \def \websitelink {https:www.jakecolburn.com}
% \def \websitetext {jakecolburn.com}
...
\headertype{\linkedin}{\email}{\website}{\phone}{}{} % Set the order of items here
...
\section{\faPieChart}{Experience}
  ...
  \resumeEntryStart
    ...
    \resumeItemListStart
      \resumeItem {Refactored CRUD Content Ingestion System. Added queue system supporting multiple languages, improving the performance of \textit{FreeTV}, Olympusat’s flagship streaming platform.}
